...
namespace PimpMyRide.Core.Data.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private Repository<RentCar> _rentCarRepository;
        ...
        public IRepository<RentCar> RentCarRepository =>
            _rentCarRepository ?? (_rentCarRepository = new Repository<RentCar>(_context));
